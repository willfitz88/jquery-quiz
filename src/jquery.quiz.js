...
$.quiz = function(el, options) {
  ...
  base.methods = {
    ...
    finish: function() {
      ...
      if(score !== numQuestions){ //If not full marks
        //base.methods.home();
        //return;
      }
      ...
      $(resultsScreen).show();
      var resultsStr = base.options.resultsFormat.replace('%score', score).replace('%total', numQuestions).replace('%msg', userMessage);
